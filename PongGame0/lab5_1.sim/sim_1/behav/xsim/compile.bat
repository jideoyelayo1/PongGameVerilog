...
REM
REM Generated by Vivado on Wed Mar 30 12:24:04 +0100 2022
...
echo "xvlog --incr --relax -prj game_tp_vlog.prj"
call xvlog  --incr --relax -prj game_tp_vlog.prj -log xvlog.log
