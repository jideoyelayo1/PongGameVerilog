...
HD_PWD='C:/Users/JideO/Downloads/PongGame0/lab5_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_tp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_tp.tcl
