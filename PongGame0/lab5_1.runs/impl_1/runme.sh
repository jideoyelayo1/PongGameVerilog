...
HD_PWD='C:/Users/JideO/Downloads/PongGame0/lab5_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_tp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_tp.tcl -notrace
